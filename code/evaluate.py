...
parser.add_argument('--true-path',default = '../input/txt', help='full path to the folder')
parser.add_argument('--pred-path',default = '../output_txt', help='full path to the folder')
